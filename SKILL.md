...
# /forge-lite - Simple Figma URL Builder
...
The page matches your Figma design and screenshot layout.
```
...
**Simple is better:**
- No complex analysis phase (Opus)
- No verification loop (Haiku)
- No iteration cycles
- Just: decompose → fetch → build → assemble

**URL-based is accurate:**
- Direct node ID fetching gives cleaner specs
- No timing issues with selections
- Reproducible (same URLs = same result)
- Parallel fetching is fast

**Achieves pixel perfection:**
- Components get exact specs from Figma
- Parallel building keeps each agent focused
- Screenshot provides layout context
- No intermediate steps to lose precision
...
- Any time you want pixel-perfect results
